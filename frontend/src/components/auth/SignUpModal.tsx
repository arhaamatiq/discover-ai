...
export function SignUpModal({ onClose, onSwitchToLogin, onSuccess }: Props) {
  ...
  async function handleSubmit() {
    ...
    setSubmitting(true);
    setError("");
    const err = await signUp(email.trim(), password.trim(), name.trim());
    setSubmitting(false);
    if (err) {
      setError(err);
    } else {
  ...
  return (
    ...
    >
      <div
        ...
        style={{ width: "403.59px", height: "568.58px" }}
      >
        {/* Close button */}
        <button
          onClick={onClose}
          ...
          style={{ top: "9.94px", right: "10.43px", width: "13.88px", height: "13.88px" }}
        >
        ...
        {/* Subtitle */}
        <p className="absolute text-[#B9B9B9]" style={{ top: "74.95px", left: "36.78px", fontSize: "16px", lineHeight: "1.21" }}>
        ...
        {/* Name label + input */}
        <label className="absolute text-[#646464]" style={{ top: "208.18px", left: "80.6px", fontSize: "16px" }}>
          Name
        </label>
        <div className="absolute" style={{ top: "232.09px", left: "77.82px", width: "247.95px" }}>
          <input
            type="text"
            value={name}
        ...
        {/* Email label + input */}
        <label className="absolute text-[#646464]" style={{ top: "274.69px", left: "80.6px", fontSize: "16px" }}>
          Email
        </label>
        <div className="absolute" style={{ top: "298.6px", left: "78.64px", width: "247.13px" }}>
          <input
            type="email"
            value={email}
        ...
        <label className="absolute text-[#646464]" style={{ top: "341.2px", left: "80.6px", fontSize: "16px" }}>
          Password
        </label>
        <div className="absolute" style={{ top: "365.11px", left: "78.64px", width: "247.13px" }}>
          <input
            type="password"
            value={password}
        ...
        {/* Error */}
        {error && (
          <p className="absolute text-red-400 text-xs" style={{ top: "408px", left: "78.64px", maxWidth: "247px" }}>
            {error}
          </p>
        )}
        ...
        <button
          ...
          style={{ top: "429.03px", left: "147.97px", width: "118.54px", height: "38.86px", fontSize: "16px", color: "#2E2E2E" }}
        >
        ...
        <button
          ...
          style={{ top: "494.15px", left: "188.74px", fontSize: "16px" }}
        >
          login
        </button>
      </div>
